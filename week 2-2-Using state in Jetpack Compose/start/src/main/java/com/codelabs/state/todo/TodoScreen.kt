    ...
    Column {
        ...
        LazyColumn(
            ...
            items(items = items) { todo ->
                ...
                TodoRow(
                    todo = todo,
                    onItemClicked = { _ -> onStartEdit(todo) },
        ...
        Row(
            ...
            TodoInputText(
                ...
                modifier = Modifier
                    .weight(1f)
                    .padding(end = 8.dp),
                // pass the submit callback to TodoInputText
                onImeAction = submit
            )
...
//            TodoEditButton(
//                // pass the submit callback
//                onClick = submit,
//                text = "Add",
//                modifier = Modifier.align(Alignment.CenterVertically),
//                // enable if text is not blank
